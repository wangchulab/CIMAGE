...
setMethod("findPeaks.centWave", "xcmsRaw", function(object, ppm=25, peakwidth=c(20,50), snthresh=10,                                                                      prefilter=c(3,100), integrate=1, mzdiff=-0.001,                                                                               fitgauss=FALSE, scanrange= numeric(),minptsperpeak=5,                                                                        sleep=0, verbose.columns=FALSE) {
    ...
    maxGaussOverlap <- 0.5;
    minPtsAboveBaseLine <- max(minptsperpeak,minPeakWidth-2);
