...
for ($i=0; $i<$ncol; ++$i) {
    ...
    print STDOUT "<TH bgcolor=\"HoneyDew\"><A HREF=\"http://162.105.22.250/cgi-bin/chuquest/cimage_sort_compare_table.pl?dset=$dset&colname=$header[$i]&ascending=True&ddir=$ddir\" style=\"text-decoration:none\">^</A> <A HREF=\"http://162.105.22.250/cgi-bin/chuquest/cimage_sort_compare_table.pl?dset=$dset&colname=$header[$i]&ascending=False&ddir=$ddir\" style=\"text-decoration:none\">v</A>\n";
}
}
print STDOUT "<TBODY>\n";
for ($i=1; $i<$nrow; ++$i) {
