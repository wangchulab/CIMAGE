...
$excelfile = "/home/gabriels/public_html/batch_annotated/$dsetbase.xls";
$excellink = "/~gabriels/batch_annotated/$dsetbase.xls";
...
=pod
open (TXTOUT, '>' . "/home/gabriels/concys/batch_annotated/annotation_$dsetbase") or die "er test"; #' #. $dset . '.annotated') or die "er txtout";
